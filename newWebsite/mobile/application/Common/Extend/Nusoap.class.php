...
* @access   public
*/
class soapclient1 extends nusoap_base  {
...
//    var $decode_utf8 = true;
	...
	* @access   public
	*/
	function soapclient1($endpoint,$wsdl = false,$proxyhost = false,$proxyport = false,$proxyusername = false, $proxypassword = false, $timeout = 0, $response_timeout = 30){
	...
	*/
	function getProxy(){
		...
		$r = rand();
		$evalStr = 'class soap_proxy_'.$r.' extends soapclient1 {
				'.$evalStr.'
			}';
