 ...
 * ====================================
 * Author: 9004396
 * Date: 2017-03-27 12:56
 * ====================================
 * Project: new.m.chinaskin.cn
 * File: SystemInfo.class.php
 * ====================================
 */
...
class SystemInfo
{
    ...
    public static function getInfo()
    {
        ...
        switch (PHP_OS) {
            case "Linux":
                $sysReShow = (false !== ($sysInfo = self::linux())) ? "show" : "none";
                break;
            case "FreeBSD":
                $sysReShow = (false !== ($sysInfo = self::freebsd())) ? "show" : "none";
                break;
            case "WINNT":
                $sysReShow = (false !== ($sysInfo = self::windows())) ? "show" : "none";
                break;
            default:
                break;
        }
     ...
     * @return bool|string
     */
    private static function get_key($keyName)
    {
     ...
     * @return bool|string
     */
    private static function find_command($commandName)
    {
     ...
     * @return bool|string
     */
    private static function do_command($commandName, $args)
    {
        $buffer = "";
...
//        $swapinfo = self::GetWMI($wmi,"Win32_PageFileUsage", array('AllocatedBaseSize','CurrentUsage'));
    ...
    private static function GetWMI($wmi, $strClass, $strValue = array())
    {
        $arrData = array();
